...
#     bash scripts/run_cups_stage3_eomt_v2_santosh.sh
#
...
CONFIG="${CONFIG:-configs/train_self_cityscapes_eomt_dinov2_dcfa_simcf_abc_santosh_v2_antidrift.yaml}"
EXP_DIR="/home/santosh/experiments/stage3_cups_orig_eomt_dinov2_dcfa_simcf_abc_spherical_k80_v2_antidrift"
...
LOG_FILE="${LOG_DIR}/cups_stage3_eomt_v2_${STAMP}.log"
...
echo "${PID}" > "${LOG_DIR}/cups_stage3_eomt_v2_${STAMP}.pid"
disown ${PID} || true
