...
\label{eq:residual}
\end{equation}
The construction has approximately 40K trainable parameters, small relative to the $\sim$86M parameters of the frozen ViT backbone. Zero initialisation of the output projection makes $\tilde z_u = z_u$ at step 0, so any departure from the frozen code is acquired gradually under the loss below.
