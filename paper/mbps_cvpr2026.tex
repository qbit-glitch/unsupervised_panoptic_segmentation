...
\label{eq:residual}
\end{equation}
The construction has approximately 40K trainable parameters, small relative to the $\sim$86M parameters of the frozen ViT backbone. Because the output projection is zero-initialized, $\tilde z_u = z_u$ at the first optimizer step.
