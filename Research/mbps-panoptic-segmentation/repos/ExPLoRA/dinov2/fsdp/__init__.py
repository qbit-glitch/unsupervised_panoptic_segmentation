...
from torch.distributed.fsdp.wrap import ModuleWrapPolicy, lambda_auto_wrap_policy
from torch.distributed.fsdp._runtime_utils import _reshard


def get_fsdp_wrapper(model_cfg, modules_to_wrap=set(), states_to_ignore=set()):
    ...
    fsdp_wrapper = partial(
        ...
        # ignored_states=states_to_ignore,
    )
    return fsdp_wrapper
