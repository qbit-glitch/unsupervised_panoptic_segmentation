...
train_csv="${base_csv_dir}/temporal_train.csv"
val_csv="${base_csv_dir}/temporal_val.csv"
...
out_dir="${base_experiment_dir}/${lora_type}_mae_pretrain-blk23r32-e60_${dataset_type}-finetune_${lora_rank}_bs128"

torchrun --nproc_per_node=$num_gpus --master_port=40002 finetune/finetune.py \
   --wandb=fmow_lora \
   --output_dir="${out_dir}" \
   --log_dir="${out_dir}" \
