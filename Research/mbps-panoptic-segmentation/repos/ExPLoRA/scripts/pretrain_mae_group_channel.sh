...
train_csv="${base_csv_dir}/sentinel_train.csv"
val_csv="${base_csv_dir}/sentinel_val.csv"
...
out_dir="${base_experiment_dir}/${lora_type}_in-weights_${dataset_type}-pretrain_blk0-23_r${lora_rank}_dr${decoder_lora_rank}-bs1024"

torchrun --nproc_per_node=$num_gpus --master_port=49998 mae/pretrain.py \
    ...
    --unfreeze_embed --unfreeze_norm --unfreeze_cls_token --unfreeze_blocks 0 23 --lora_layers attn  \
