...
out_dir="${base_experiment_dir}/${lora_type}_mae_pretrain-blk0-23r64dr16-e55_${dataset_type}-finetune_${lora_rank}_bs128"

torchrun --nproc_per_node=$num_gpus --master_port=40003 finetune/finetune.py \
   --wandb=fmow_lora \
   --output_dir="${out_dir}" \
   --log_dir="${out_dir}" \
