"""Cross-dataset assessment: DINOv3 Stage-3 on BDD-10K Panoptic (OOD evaluation).
...
BDD-10K uses 27 Cityscapes classes (mapped via bdd2cs_class_mapping).
"""
import gc
import json
import os
...
from cups.data.bdd import BDD10kPanopticValidation
...
def main():
    ...
    parser.add_argument("--output_json", type=str, default="results/bdd_eval.json",
    ...
    # Validation dataset — BDD-10K maps to 27 Cityscapes classes
    validation_dataset = BDD10kPanopticValidation(
    ...
    # Print summary
    log.info("\n" + "=" * 60)
    log.info("BDD-10K Cross-Dataset Results (OOD)")
    log.info("=" * 60)
