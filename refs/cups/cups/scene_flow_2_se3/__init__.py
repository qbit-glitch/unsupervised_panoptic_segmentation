...
# Core utilities needed by training pipeline
...
# Heavy scene flow imports (optional — only needed for pseudo-label generation)
try:
    ...
    pass  # Scene flow modules not available (open3d, etc.) — not needed for training
...
def sf2se3(
    ...
    if valid_pixels is not None:
        vp_bool = valid_pixels.bool()
        data["pt3d_valid_0"] = data["pt3d_valid_0"] & vp_bool
        data["pt3d_valid_f0_1"] = data["pt3d_valid_f0_1"] & vp_bool
