...
def my_app(cfg: DictConfig) -> None:
    ...
    dataset_names = ["cityscapes"]   # GA-DepthG Stage A
    crop_types = [None]              # GA-DepthG: non-cropped (CityscapesSeg + geometry)
    ...
    res = 224   # GA-DepthG: faster training res (eval still at 320)
    n_batches = 64 #16
