...
from geometry_features import geometric_affinity  # GA-DepthG: height+normal affinity
...
class ContrastiveCorrelationLoss(nn.Module):
    ...
    def depth_feature_correlation(self, c1, c2, d1, d2, shift):
        ...
        # GA-DepthG: scalar depth correlation (DepthG) OR geometric (height+normal) affinity (ours)
