...
class BasicMotionEncoder(nn.Module):
    ...
    def forward(self, flow, corr):
        cor = self.act(self.convc1(corr)) # was F.relu()
...
class BasicUpdateBlock(nn.Module):
    def __init__(self, args, correlation_depth, hidden_dim=128, input_dim=256, scale=2):
    ...
    def forward(self, net, inp, corr, flow): 
        ...
        inp_cat = torch.cat([inp, motion_features, inp], dim=1)
