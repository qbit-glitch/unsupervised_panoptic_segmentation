...
This is our <u>S</u>imple <u>Un</u>supervised <u>RAFT</u> `Sun-RAFT` ☀️ repository.
...
For our <u>Mu</u>lti-Scale <u>Un</u>supervised <u>RAFT</u> (`Muun-RAFT` 🌑) repository check out:
[https://github.com/cv-stuttgart/Muun-RAFT](https://github.com/cv-stuttgart/Muun-RAFT)
...
You can find our trained models under [Releases](https://github.com/cv-stuttgart/Sun-RAFT/releases/tag/v1.0.0).
...
```Shell
python evaluate.py --model models/Sun-RAFT_sintel-test.pth --dataset sintel
```
...
```Shell
python train_un.py --config config/Sun-RAFT_chairs-sintel.json
```

and to train the network on Chairs and then on KITTI (sequentially) please run:

```Shell
python train_un.py --config config/Sun-RAFT_chairs-kitti.json
```
...
## Acknowledgement
Parts of this repository are adapted from [Unflow](https://github.com/simonmeister/UnFlow) ([MIT license](https://github.com/simonmeister/UnFlow/blob/master/LICENSE)), [SMURF](https://github.com/google-research/google-research/tree/master/smurf) ([Apache 2.0 license](https://github.com/google-research/google-research/blob/master/LICENSE)), and [RAFT](https://github.com/princeton-vl/RAFT) ([MIT license](https://github.com/princeton-vl/RAFT/blob/master/LICENSE)).
